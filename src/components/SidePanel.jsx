...
function SidePanel() {
  ...
  return (
    <div className="relative flex justify-end h-full bg-secondary border-r border-borderColor transition-all duration-150">
      <div className="flex">
        <div className="flex-shrink-0 flex flex-col items-center justify-between bg-secondary border-r border-borderColor p-3">
            <div className='flex flex-col gap-4'>
                <div onClick={handleNewChat} className="bg-tertiary p-3 rounded-md border border-borderColor cursor-pointer">
            ...
            <h2 className='w-10 h-10 bg-tertiary grid place-content-center border border-borderColor rounded-full'>K</h2>
        </div>
